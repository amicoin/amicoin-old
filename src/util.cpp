...
{
    return "\n" +
           FormatParagraph(strprintf(_("In order to ensure you are adequately protecting your privacy when using AMICoin, please see <%s>."),
...
std::string LicenseInfo()
{
    return "\n" +
           ...
           FormatParagraph(strprintf(_("Copyright (C) 2017-%i amicoin.org"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
